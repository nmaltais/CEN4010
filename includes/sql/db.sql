...
CREATE TABLE TIMESHEETS (
    EMPLOYEE_ID         INT NOT NULL,
    TIMESHEET_TIMESTAMP TIMESTAMP NOT NULL,
    TIMESHEET_TYPE      TINYINT(1) NOT NULL,
    
    FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEES (EMPLOYEE_ID),
    PRIMARY KEY (EMPLOYEE_ID, TIMESHEET_TIMESTAMP, TIMESHEET_TYPE)
);
...
INSERT INTO ACCESS_LEVELS (ACCESS_LEVEL_ID, ACCESS_LEVEL_NAME) VALUES (-1, 'Unknown');

INSERT INTO COMPANIES (COMPANY_ID, COMPANY_NAME) VALUES (-1, 'Unknown');
